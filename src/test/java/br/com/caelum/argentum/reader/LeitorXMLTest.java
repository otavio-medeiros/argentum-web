...
public class LeitorXMLTest {
	...
	public void testLeitorDeXMlCarregaListaDeNegocio() {
		String xmlDeTeste = "<list>" + "    <negociacao>" + "        <preco>43.5</preco>" + "        <quantidade>1000</quantidade>" + "        <data>" + "            <time>1322233344455</time>" + "        </data>" + "    </negociacao>" + "</list>";
		...
		Assert.assertEquals(negocios.get(0).getPreco(), 43.6, 0.0001);
